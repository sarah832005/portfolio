...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    subtitle: "POO · Héritage · Interfaces · Design Patterns · eLibrairie",
    year: "2025", status: "Terminé", domain: "Systèmes d'information (SI)",
    what: "Application Java de gestion de bibliothèque (eLibrairie) : gestion des ressources (livres, magazines, DVD), des utilisateurs et des emprunts via un menu interactif en console. Implémentation orientée objet complète avec héritage, interfaces, collections et gestion des exceptions.",
  ...
  },
  {
    ...
    subtitle: "Revue de littérature · État de l'art · Architecture technique · Neuro-VR",
    year: "2026", status: "En cours", domain: "IA / Machine Learning",
  ...
  },
  {
    ...
    subtitle: "Pipeline ML · 96.7% accuracy · PCA · K-Means · 100+ participants VR",
    year: "2025", status: "Terminé", domain: "IA / Machine Learning",
    what: "Volet expérimental du projet de recherche VR : collecte terrain sur 100+ participants en session VR, pipeline ML complet pour prédire le niveau de cybersickness. Classification supervisée (Logistic Regression 96.7%, SVM 95%), régression SSQ, réduction dimensionnelle PCA (13 → 11 composantes, 90% variance) et clustering K-Means (4 profils utilisateurs identifiés, silhouette=0.14).",
    concepts: ["Classification supervisée", "Régression SSQ", "PCA", "K-Means Clustering", "Feature Importance", "Cross-validation", "EDA"],
  ...
  },
  {
    ...
    subtitle: "Dossier d'Architecture Technique · Diagrammes C4 · RGPD · Cloud · ADR",
    year: "2026", status: "Terminé", domain: "Architecture & Conception",
